...
"""
*********************************************
**SETUP** - Using _espressopp with 1 core
*********************************************

 Example: Now load the fundamental modules
>>> import mpi4py.MPI
>>> import _espressopp
>>> system=_espressopp.System()
>>> bc=_espressopp.bc_OrthorhombicBC((10,10,10)) # in one core only
