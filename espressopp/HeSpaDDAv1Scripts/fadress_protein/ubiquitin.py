...
# nodeGrid = decomp.nodeGrid(size, rc, skin, NCPUs,ex_size+hy_size,ratioMS,0,[1,0,0])  # The
#===========================================================
nodeGrid           = espressopp.tools.decomp.nodeGrid(box,rc,skin,NCPUs,ex_size+hy_size,ratioMS)
...
cellGrid,neiListx,neiListy,neiListz=espressopp.tools.decomp.neiListAdress(nodeGrid, cellGrid,rc,skin,ex_size+hy_size,adrCenter,ratioMS)  # The 0 is for the IdealGas
