...
comm = MPI.COMM_WORLD
nodeGrid = decomp.nodeGrid(size, rc, skin, comm.size,ex_size+hy_size,ratioMS,1,[1,0,0])  # The 0 is for the IdealGas
print nodeGrid
cellGrid = decomp.cellGrid(size, nodeGrid, rc, skin)
cellGrid,neiListx,neiListy,neiListz=decomp.neiListAdress(nodeGrid, cellGrid,rc,skin,ex_size+hy_size,adrCenter,ratioMS,True,False,[1,0,0])  # The 0 is for the IdealGas
