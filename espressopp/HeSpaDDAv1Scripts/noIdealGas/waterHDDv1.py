...
###########################################################################
#                                                                         #
#  espressopp++ Python script for H-Adress Water simulation  based on     #
#  Gromacs topology							  #
#                                                       		  #
#                                                       		  #
###########################################################################
...
print "THIS IS AN espressopp++ SIMULATION of Water and an Ideal Gas in Adress"
print ""
...
temp = 2.494353 # kT in gromacs units
gamma = 0.5
...
# H-AdResS
rc = 1.30  # cutoff coarse-grained potential
rca = 1.0  # cutoff atomistic potential (cutoff (2^(1/6)), WCA)
skin = 0.15
# Parameters for size of AdResS dimensions
ex_size = 7.0 #100.0 #1.5
hy_size = 2.0 #2.0
...
comm = MPI.COMM_WORLD
nodeGrid = decomp.nodeGrid(size, rc, skin, comm.size,ex_size+hy_size,ratioMS,0,[1,0,0])  # The 0 is for the IdealGas
print nodeGrid
cellGrid = decomp.cellGrid(size, nodeGrid, rc, skin)
cellGrid,neiListx,neiListy,neiListz=decomp.neiListAdress(nodeGrid, cellGrid,rc,skin,ex_size+hy_size,adrCenter,ratioMS,False,False,[1,0,0])  # The 0 is for the IdealGas
...
fmt='%5.5f %15.8g %15.8g\n'# %15.8g %15.8g %15.8g %15.8g %15.8g %15.8f %15.8f\n'
...
for i in range(check):
    ...
    print (fmt%(i*steps/check*timestep, T, P))
